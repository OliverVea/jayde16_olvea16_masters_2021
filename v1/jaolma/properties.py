...
class Properties:
    ...
    feature_properties = {
        ...
        'Tree': {'origin': 'groundtruth', 'label': 'Tree (gt)', 'color': '#118a0c'},
        'Light Fixture': {'origin': 'groundtruth', 'label': 'Light Fixture (gt)', 'color': '#f2f55f'},
        'Downspout Grille': {'origin': 'groundtruth', 'label': 'Downspout Grille (gt)', 'color': '#711f80'},
        'Manhole Cover': {'origin': 'groundtruth', 'label': 'Manhole Cover (gt)', 'color': '#080d8a'},
        'Fuse Box': {'origin': 'groundtruth', 'label': 'Fuse Box (gt)', 'color': '#5c4e1c'},
        'Building Corner': {'origin': 'groundtruth', 'label': 'Building Corner (gt)', 'color': '#cc3618'},
        'Bench': {'origin': 'groundtruth', 'label': 'Bench (gt)', 'color': '#6e5942'},
        'Trash Can': {'origin': 'groundtruth', 'label': 'Trash Can (gt)', 'color': '#5c5b5b'},
        'Tree Stump': {'origin': 'groundtruth', 'label': 'Tree Stump (gt)', 'color': '#6e491b'},
        'Chimney': {'origin': 'groundtruth', 'label': 'Chimney (gt)', 'color': '#291937'},
        'Rock': {'origin': 'groundtruth', 'label': 'Rock (gt)', 'color': '#636363'},
        'Statue': {'origin': 'groundtruth', 'label': 'Statue (gt)', 'color': '#b3b3b3'},
        'Misc': {'origin': 'groundtruth', 'label': 'Misc (gt)', 'color': '#72fcfa'},
        'Greenery': {'origin': 'groundtruth', 'label': 'Greenery (gt)', 'color': '#118b0b'},
        'unknown': {'origin': 'groundtruth', 'label': 'unknown', 'color': '#000000'},
