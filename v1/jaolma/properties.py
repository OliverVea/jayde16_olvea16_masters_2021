...
class Properties:
    ...
    feature_properties = {
        ...
        'Tree': {'origin': 'gt', 'label': 'Tree (gt)', 'color': '#118a0c'},
        'Light Fixture': {'origin': 'gt', 'label': 'Light Fixture (gt)', 'color': '#f2f55f'},
        'Downspout Grille': {'origin': 'gt', 'label': 'Downspout Grille (gt)', 'color': '#711f80'},
        'Manhole Cover': {'origin': 'gt', 'label': 'Manhole Cover (gt)', 'color': '#080d8a'},
        'Fuse Box': {'origin': 'gt', 'label': 'Fuse Box (gt)', 'color': '#5c4e1c'},
        'Building Corner': {'origin': 'gt', 'label': 'Building Corner (gt)', 'color': '#cc3618'},
        'Bench': {'origin': 'gt', 'label': 'Bench (gt)', 'color': '#6e5942'},
        'Trash Can': {'origin': 'gt', 'label': 'Trash Can (gt)', 'color': '#5c5b5b'},
        'Tree Stump': {'origin': 'gt', 'label': 'Tree Stump (gt)', 'color': '#6e491b'},
        'Chimney': {'origin': 'gt', 'label': 'Chimney (gt)', 'color': '#291937'},
        ...
        'unknown': {'origin': 'gt', 'label': 'unknown', 'color': '#000000'},
        ...
        #'unknown': {'origin': 'gnss', 'label': 'unknown', 'color': '#000000'},
